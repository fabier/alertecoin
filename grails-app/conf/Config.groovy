...
environments {
    development {
        grails.serverURL = "http://localhost:8080/alertecoin"
    }
    ...
    production {
        grails.serverURL = "http://www.alertecoin.com"
    }
}
...
<br/>
Vous venez de créer un compte sur <a href="http://www.alertecoin.com">AlerteCoin</a> et nous vous en remercions !<br/>
<br/>
...
'''
                    emailFrom = 'AlerteCoin <noreply@alertecoin.com>'
                    emailSubject = 'AlerteCoin - Réinitialisation du mot de passe'
...
grails {
    mail {
        host = "smtp.1und1.de"
        port = 587
        username = "noreply@alertecoin.com"

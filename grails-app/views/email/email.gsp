            ...
            <table style="border-collapse: collapse;border-spacing: 0;width: 602px">
                ...
                <tr>
                    <td class="title"
                        ...
                        AlerteCoin - Vous avez ${classifieds.size()}
                            ...
                            <tr>
                                <td class="padded"
                                    ...
                                    <h1 style="Margin-top: 0;color: #565656;font-weight: 700;font-size: 36px;Margin-bottom: 0px;font-family: Avenir,sans-serif;line-height: 42px">
                                        <g:link controller="alert" action="show" id="${alert.id}" absolute="true"
                                                target="_blank" style="text-decoration: none;">AlerteCoin</g:link>
                                    </h1>
                                    ...
                                    <p style="Margin-top: 0px;color: #565656;font-family: Georgia,serif;font-size: 16px;line-height: 25px;Margin-bottom: 0px">
                                        <g:if test="${classifieds.size() > 1}">
                                            ...
                                            pour l'alerte «${alert.name}»
                                            <br/>
                                            <g:message code="alertecoin.email.3.plural"/>
                                        </g:if>
                                        <g:else>
                                            ${classifieds.size()}
                                            ...
                                            pour l'alerte «${alert.name}»
                                            <br/>
                                            <g:message code="alertecoin.email.3.single"/>
                                        </g:else>
                                    </p>
                ...
                <g:each in="${classifieds}" var="classified">
                    <tr>
                        <td class="column first"
                            ...
                            <div class="image" style="font-size: 0;margin: 5px;border: 1px #c0c0c0 solid;padding:5px;"
                                 align="center">
                                <g:if test="${classified.images}">
                                    <g:link url="${classified.url}" target="_blank" absolute="true"
                                        ...
                                        <img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top gnd-corner-image-bottom"
                                             ...
                                             src="${classified.images.first().url}" alt="" width="auto" height="100"/>
                                    </g:link>
                                </g:if>
                            </div>
                        </td>
                        <td class="column second"
                            ...
                            <div>
                                <div class="column-top" style="font-size: 10px;line-height: 10px">&nbsp;</div>
                            </div>
                            <table class="contents" style="border-collapse: collapse;border-spacing: 0;width: 100%">
                                <tbody>
                                <tr>
                                    <td class="padded-small"
                                        ...
                                        <g:link url="${classified.url}" target="_blank" absolute="true"
                                                style="text-decoration: none;">
                                            <p style="Margin-top: 0;color: #303060;font-family: Georgia,serif;font-size: 18px;line-height: 30px;Margin-bottom: 0px; text-decoration: none;font-weight:bold; display:inline-block;text-overflow: ellipsis;overflow: hidden;white-space: nowrap;width:380px;max-width: 380px;">
                                                ${classified.name}
                                            </p>

                                            <p style="Margin-top: 0;color: #404040;font-family: Georgia,serif;font-size: 14px;line-height: 12px;Margin-bottom: 0px;text-decoration: none;">
                                                <br/>
                                                <g:if test="${classified.price}">
                                                    <strong>${classified.price} €</strong>
                                                </g:if>
                                                <g:else>
                                                    <em style="color: #a0a0a0">Prix non renseigné</em>
                                                </g:else>
                                                <br/>
                                                <br/>
                                                <g:if test="${classified.date}">
                            ...
                            <div class="column-bottom" style="font-size: 2px;line-height: 2px">&nbsp;</div>
                        </td>
                    </tr>
                </g:each>
                </tbody>
                        ...
                        <table class="contents" style="border-collapse: collapse;border-spacing: 0;width: 100%">
                            ...
                            <tr>
                                <td class="padded"
                                    ...
                                    <g:link controller="alert" action="edit" id="${alert.id}" absolute="true"
                                            style="text-decoration: none;">

...
<head>
    ...
    <meta property="og:title" content="AlerteCoin"/>
</head>

<body style="margin: 0;padding: 0;min-width: 100%;background-color: #fbfbfb">
<style type="text/css">
body.noop {
    border-width: 0px
}
...
.feature blockquote p, .feature blockquote ol, .feature blockquote ul {
    line-height: 50px
}
...
.wrapper .feature p a, .wrapper .feature ol a, .wrapper .feature ul a {
    border-bottom: 1px solid #41637e
}

.wrapper .feature p a:hover, .wrapper .feature ol a:hover, .wrapper .feature ul a:hover {
    color: #30495c !important;
...
.wrapper .footer .social .social-text, .wrapper
.footer .social a {
    font-family: Georgia, serif
}
...
table.two-col tr:hover td.first,
table.two-col tr:hover td.second {
...
table.two-col tr:hover td.first div {
...
table.two-col tr:hover td.second p,
table.two-col tr:hover td.second span {
    color: #ffffff !important;
    text-decoration: none;
    cursor: hand;
}
...
<table class="wrapper"
       style="border-collapse: collapse;border-spacing: 0;display: table;table-layout: fixed;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;text-rendering: optimizeLegibility;background-color: #fbfbfb">
    <tbody>
    <tr>
                                            ...
                                            <tr>
                                                <td class="padded"
                                                    ...
                                                    <p style="text-align:center;margin-top: 0px;color: #A6A6A6;font-family: Georgia,serif;font-size: 16px;line-height: 25px;margin-bottom: 16px">
                                                        <g:link controller="alert" action="show" id="${alert.id}"
                                                                absolute="true" target="_blank" style="text-decoration: none;">
                                                            ${classifieds.size()}
                                                            <g:message
                                    ...
                                    <tr>
                                        <td class="column first"
                                            ...
                                            <g:if test="${classified.images}">
                                                <div class="image"
                                                     style="font-size: 0;margin: 5px;border: 1px #c0c0c0 solid;padding:5px;"
                                                     align="center">
                                                    <g:link url="${classified.url}" target="_blank" absolute="true"
                                                        ...
                                                        <img class="gnd-corner-image gnd-corner-image-center gnd-corner-image-top gnd-corner-image-bottom"
                                                             style="-ms-interpolation-mode: bicubic;display: block;max-width: 150px"
                                                             src="${createLink(controller: "image", action: "get", id: classified.images.first().id, absolute: true)}"
                                                             alt="" width="auto"
                                                             height="100"/>
                                                    </g:link>
                                                </div>
                                        ...
                                        <td class="column second"
                                            style="padding: 0;vertical-align: top;text-align: left;width: 450px">
                                            <div>
                                                <div class="column-top"
                                            ...
                                            <table class="contents"
                                                ...
                                                <tr>
                                                    <td class="padded-small"
                                                        style="vertical-align: middle;padding: 4px 20px;">
                                                        <g:link url="${classified.url}" target="_blank" absolute="true"
                                                                style="text-decoration: none;">
                                                            <p style="display:inline-block;width:290px;max-width:290px;overflow:hidden;text-overflow: ellipsis;text-wrap:none;word-wrap:normal;white-space:nowrap;
                                                            color: #154162;font-family: Arial, Helvetica, sans-serif;font-size: 18px;line-height: 20px; text-decoration: none;margin:0;padding: 1px 0;">
                                                                <strong>${classified.name}</strong>
                                                            </p>
                                                            <p style="color: #154162;font-family: Arial, Helvetica, sans-serif;font-size: 12px;line-height: 14px; text-decoration: none;margin:0;padding: 1px 0;">
                                                                <span>${classified.location}</span>
                                                            </p>
                                                            <p style="color: #c0c0d0;font-family: Arial, Helvetica, sans-serif;font-size: 10px;line-height: 12px; text-decoration: none;margin:0;padding: 1px 0;">
                                                                <g:formatDate date="${classified.date}"
                                                                              format="d MMM HH:mm"/>
                                                            </p>
                                                        </g:link>
                                                    </td>
                                                    <td class="padded-small" style="padding: 0;vertical-align: middle;" align="right">
                                                        <g:link url="${classified.url}" target="_blank" absolute="true"
                                                                style="text-decoration: none;text-align: center;">
                                                            <span style="display:inline-block;font-family: Arial, Helvetica, sans-serif;font-size:14px;color: #FFFFFF;
                                                            padding:3px 8px; margin: 0 20px 0 0; border-radius:3px; background-color:#f0ad4e;white-space: nowrap">
                                            ...
                                            <div class="column-bottom"
                                                 style="font-size: 2px;line-height: 2px">&nbsp;</div>
                                        </td>
                                    </tr>
                                </g:each>
                                </tbody>
                    ...
                    <tr>
                        <td>
                            <table class="contents" style="border-collapse: collapse;border-spacing: 0;width: 100%">
                                ...
                                <tr>
                                    <td class="padded"
                                        style="padding: 0;vertical-align: top;padding-left: 0;padding-right: 10px;text-align: center;font-size: 12px;line-height: 20px;color: #999;font-family: Georgia,serif">
                                        <div>Vous recevez ce mail parce que vous avez créé une alerte sur AlerteCoin</div>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                    ...
                    <tr>
                        <td style="padding: 0;vertical-align: top">
                            <table style="border-collapse: collapse;border-spacing: 0">
                                ...
                                <tr>
                                    <td class="address"
                                        style="padding: 0;vertical-align: top;width: 250px;padding-top: 0px;">
                                        <table class="contents"
                                               style="border-collapse: collapse;border-spacing: 0;width: 100%">
                                            <tbody>
                                            <tr>
                                                <td class="padded"
                                                    ...
                                                    <g:link controller="alert" action="edit" id="${alert.id}"
                                                            absolute="true"
                                                            style="text-decoration: none;">
                                    ...
                                    <td class="subscription"
                                        style="padding: 0;vertical-align: top;width: 350px;padding-top: 0px;">
                                        <table class="contents"
                                               style="border-collapse: collapse;border-spacing: 0;width: 100%">
                                            <tbody>
                                            <tr>
                                                <td class="padded"
                                                    ...
                                                    <g:link controller="alert" action="confirmDelete" id="${alert.id}"
                                                            absolute="true"
                    ...
                    <tr>
                        <td>
                            <table class="contents" style="border-collapse: collapse;border-spacing: 0;width: 100%">
                                ...
                                <tr>
                                    <td class="padded"
                                        style="padding: 0;vertical-align: top;padding-left: 0;padding-right: 10px;text-align: center;font-size: 12px;line-height: 20px;color: #999;font-family: Georgia,serif;padding-bottom: 64px">
                                        <div>&copy; AlerteCoin 2014 - <g:getYear/></div>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
